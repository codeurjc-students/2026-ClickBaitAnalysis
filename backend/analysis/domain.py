"""El vocabulario del análisis: señales, dimensiones y veredicto.

Estos tipos describen **qué es el clickbait para este sistema**, no cómo se
sirve. Por eso viven aquí y no en ``api/schemas.py``: existirían igual si el
proyecto fuera sólo un servidor MCP, o sólo una función de Python.

Tres principios los gobiernan:
